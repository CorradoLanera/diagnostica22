...
- una variabile casuale che assume un .orange[insieme discreto] di valori con probabilità specificata è detta variabile casuale **discreta**
...
Se $n=1$ la distribuzione binomiale prende il nome di distribuzione di Bernulli.
